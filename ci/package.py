...
class UfsWeatherModel(CMakePackage):
    ...
    depends_on("sp")
    # depends_on("w3emc")
    depends_on("w3emc@add_module", patches=patch("https://github.com/AlexanderRichert-NOAA/NCEPLIBS-w3emc/archive/d923949dc98e85f440698c3a79b57aff6302fec6.tar.gz", sha256="ce1c79326084606776100868297072522858169e590748259250003250390230"))
    ...
    depends_on("esmf@8.8.0:", when="@develop")
    ...
    depends_on("netcdf-c@4.7.4: ~parallel-netcdf+mpi", when="@develop")
    for app in [
        "ATMW",
        "ATML",
        "NG-GODAS",
