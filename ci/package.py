...
class UfsWeatherModel(CMakePackage):
    ...
    depends_on("sp")
    # depends_on("w3emc")
    depends_on("w3emc@add_module", patches=patch("https://github.com/AlexanderRichert-NOAA/NCEPLIBS-w3emc/archive/035a2a2e3356ad469c68c9edf659f89416417fe2.tar.gz", sha256="035a2a2e3356ad469c68c9edf659f89416417fe2"))
