...
* `UFS WM User’s Guide <https://ufs-weather-model.readthedocs.io/en/release-public-v3.0.0/>`__ (released with SRW APP v3.0.0)
* `UFS WM User’s Guide <https://ufs-weather-model.readthedocs.io/en/ufs-srw-v2.2.0-doc/>`__ (released with SRW App v2.2.0)
